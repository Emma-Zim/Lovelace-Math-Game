...
places each random interger inside a box. If the player clicks on the box with the greatest integer the box turns green.
if the player clicks on the box that is not the greatest integer the box turns blue and game over.The counter keeps going until the player 
chooses a number that is not the greatest.
